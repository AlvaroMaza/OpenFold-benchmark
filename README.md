...
<b>3. Send the folders with the fasta files and the aligments to .../lustre/projects/... </b>
...
<li>To reduce the size of the output pickle, filter_pickle is executed at the end of this script. It excludes the parts of the pickle that weighted the most. Be sure to have pickle.py downloaded, or comment that line if you want the whole pickle output.</li>
</ul>
